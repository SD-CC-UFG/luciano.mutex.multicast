...
import com.lucianomoura.sdmulticastrl.Model.EstadoProcesso;
import com.lucianomoura.sdmulticastrl.Model.acoesProcesso;
...
public class Processo implements acoesProcesso {
    ...
    public int retornaMenorTempoDaFilaDePedidos()
    {
        ...
        {
            Processo processo = filaDeMensagens.get(i).getpOrigem();
